...
Original file is located at
    https://colab.research.google.com/drive/1XyyHArb6yMgssINUUe3KSDcr8GzfKSR8
"""
                        ...
                        <tr>
                            <td style="padding: 30px; background-color: #000000; text-align: center; border-top: 3px solid #000000;">
                                ...
                                <div style="margin: 20px 0;">
                                    <a href="https://Mehul.me" style="display: inline-block; margin: 0 10px; padding: 12px 24px; background-color: #ffffff; color: #000000; text-decoration: none; font-weight: 900; font-size: 12px; border: 2px solid #ffffff; text-transform: uppercase; letter-spacing: 1px;">
                                        🌐 WEBSITE
                                    </a>
                                    <a href="https://www.linkedin.com/in/Mehul-Luthra/" style="display: inline-block; margin: 0 10px; padding: 12px 24px; background-color: #ffffff; color: #000000; text-decoration: none; font-weight: 900; font-size: 12px; border: 2px solid #ffffff; text-transform: uppercase; letter-spacing: 1px;">
                                        💼 LINKEDIN
                                    </a>
                                    <a href="https://www.instagram.com/haryiank" style="display: inline-block; margin: 0 10px; padding: 12px 24px; background-color: #ffffff; color: #000000; text-decoration: none; font-weight: 900; font-size: 12px; border: 2px solid #ffffff; text-transform: uppercase; letter-spacing: 1px;">
                                        📸 INSTAGRAM
                                    </a>
                                </div>
                            </td>
